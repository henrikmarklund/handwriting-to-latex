...
def get_decoder_data(target_texts, target_characters, num_decoder_tokens, max_decoder_seq_length, target_token_index):
    ...
    print("Number of tokens not in the vocab: ", num_other)
    return [decoder_input_data, decoder_target_data]


def get_decoder_data_int_sequences(target_texts, target_characters, num_decoder_tokens, max_decoder_seq_length, target_token_index):
